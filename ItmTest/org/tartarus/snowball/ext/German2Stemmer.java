...
// Source File Name:   German2Stemmer.java
...
label0:
		do
		{
			v_1 = cursor;
			bra = cursor;
			int among_var = find_among(a_1, 6);
			if (among_var == 0)
				break;
			ket = cursor;
			switch (among_var)
	...
	private boolean r_standard_suffix()
	{
		...
		ket = cursor;
		int among_var = find_among_b(a_2, 7);
		if (among_var != 0)
		{
			bra = cursor;
			if (r_R1())
	...
	public int hashCode()
	{
		return org/tartarus/snowball/ext/German2Stemmer.getName().hashCode();
	}

	static 
	{
		methodObject = new German2Stemmer();
		a_0 = (new Among[] {
			new Among("", -1, 6, "", methodObject), new Among("ae", 0, 2, "", methodObject), new Among("oe", 0, 3, "", methodObject), new Among("qu", 0, 5, "", methodObject), new Among("ue", 0, 4, "", methodObject), new Among("\337", 0, 1, "", methodObject)
		});
		a_1 = (new Among[] {
