...
//			DefaultCategoryFactory, PropertyWatchdog, Appender, Layout, 
//			NameValue, SortedKeyEnumeration, LogManager, Level, 
//			Logger
	...
	implements Configurator
{
	...
	protected void configureLoggerFactory(Properties props)
	{
		...
		if (factoryClassName != null)
		{
			...
			loggerFactory = (LoggerFactory)OptionConverter.instantiateByClassName(factoryClassName, org.apache.log4j.spi.LoggerFactory.class, loggerFactory);
	...
	protected void parseCatsAndRenderers(Properties props, LoggerRepository hierarchy)
	{
		...
		do
		{
			...
			{
				ThrowableRenderer tr = (ThrowableRenderer)OptionConverter.instantiateByKey(props, "log4j.throwableRenderer", org.apache.log4j.spi.ThrowableRenderer.class, null);
				if (tr == null)
				{
	...
	private void parseErrorHandler(ErrorHandler eh, String errorHandlerPrefix, Properties props, LoggerRepository hierarchy)
	{
		...
		if (loggerName != null)
		{
			Logger logger = loggerFactory != null ? hierarchy.getLogger(loggerName, loggerFactory) : hierarchy.getLogger(loggerName);
			eh.setLogger(logger);
		}
		...
		do
		{
			...
			if (clazz != null)
			{
				...
				if (filter != null)
				{
					...
					NameValue kv;
					for (Enumeration filterProps = v.elements(); filterProps.hasMoreElements(); propSetter.setProperty(kv.key, kv.value))
						kv = (NameValue)filterProps.nextElement();
