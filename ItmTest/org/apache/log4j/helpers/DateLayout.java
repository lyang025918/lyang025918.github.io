...
// Source File Name:   DateLayout.java
...
public abstract class DateLayout extends Layout
{
	...
	/**
	 * @deprecated Field DATE_FORMAT_OPTION is deprecated
	 */
	public static final String DATE_FORMAT_OPTION = "DateFormat";
	/**
	 * @deprecated Field TIMEZONE_OPTION is deprecated
	 */
	...
	public void setOption(String option, String value)
	{
		...
		if (option.equalsIgnoreCase("TimeZone"))
			timeZoneID = value;
	}
	...
	public void setDateFormat(String dateFormatType, TimeZone timeZone)
	{
		...
		if (dateFormatType.equalsIgnoreCase("RELATIVE"))
			dateFormat = new RelativeTimeDateFormat();
		else
		if (dateFormatType.equalsIgnoreCase("ABSOLUTE"))
			dateFormat = new AbsoluteTimeDateFormat(timeZone);
		else
		if (dateFormatType.equalsIgnoreCase("DATE"))
			dateFormat = new DateTimeDateFormat(timeZone);
		else
		if (dateFormatType.equalsIgnoreCase("ISO8601"))
		{
