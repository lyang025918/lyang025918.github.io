	...
	implements UnrecognizedElementHandler
{
		...
		throws MessagingException
	{
		...
		if (cc != null && cc.length() > 0)
			msg.setRecipients(javax.mail.Message.RecipientType.CC, parseAddress(cc));
		if (bcc != null && bcc.length() > 0)
			msg.setRecipients(javax.mail.Message.RecipientType.BCC, parseAddress(bcc));
	}
	...
	{
		return evaluator != null ? evaluator.getClass().getName() : null;
	}
	...
	{
		evaluator = (TriggeringEventEvaluator)OptionConverter.instantiateByClassName(value, org.apache.log4j.spi.TriggeringEventEvaluator.class, evaluator);
	}
		...
		throws Exception
	{
		...
		{
			Object triggerPolicy = DOMConfigurator.parseElement(element, props, org.apache.log4j.spi.TriggeringEventEvaluator.class);
