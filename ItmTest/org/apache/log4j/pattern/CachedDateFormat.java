...
// Source File Name:   CachedDateFormat.java
...
public final class CachedDateFormat extends DateFormat
{
	...
	public StringBuffer format(long now, StringBuffer buf)
	{
		...
		if (millisecondStart != -1 && now < slotBegin + (long)expiration && now >= slotBegin && now < slotBegin + 1000L)
		{
	...
	public static int getMaximumCacheValidity(String pattern)
	{
		...
		return firstS < 0 || firstS == pattern.lastIndexOf("SSS") ? 1000 : 1;
	}
}
