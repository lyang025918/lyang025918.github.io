...
// Source File Name:   LoggingEvent.java
	...
	implements Serializable
{
	...
	public LoggingEvent(String fqnOfCategoryClass, Category logger, long timeStamp, Level level, Object message, String threadName, 
		...
		throws IOException, ClassNotFoundException
	{
		...
		try
		{
			...
			} else
			{
				...
				level = (Level)m.invoke(null, new Integer[] {
					new Integer(p)
				});
			}
		}
