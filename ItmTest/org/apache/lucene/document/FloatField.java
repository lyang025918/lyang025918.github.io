...
// Source File Name:   FloatField.java
...
public final class FloatField extends Field
{
	...
	public FloatField(String name, float value, FieldType type)
	{
		...
		{
			throw new IllegalArgumentException((new StringBuilder()).append("type.numericType() must be FLOAT but got ").append(type.numericType()).toString());
		} else
		{
			fieldsData = Float.valueOf(value);
			return;
