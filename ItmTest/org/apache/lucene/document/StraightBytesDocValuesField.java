...
// Source File Name:   StraightBytesDocValuesField.java
...
public class StraightBytesDocValuesField extends Field
{
	...
	static 
	{
		...
		TYPE_FIXED_LEN.setDocValueType(org.apache.lucene.index.DocValues.Type.BYTES_FIXED_STRAIGHT);
		TYPE_FIXED_LEN.freeze();
		TYPE_VAR_LEN = new FieldType();
		TYPE_VAR_LEN.setDocValueType(org.apache.lucene.index.DocValues.Type.BYTES_VAR_STRAIGHT);
		TYPE_VAR_LEN.freeze();
	}
}
