...
// Source File Name:   WhitespaceAnalyzer.java
...
public final class WhitespaceAnalyzer extends Analyzer
{
	...
	{
		return new org.apache.lucene.analysis.Analyzer.TokenStreamComponents(new WhitespaceTokenizer(matchVersion, reader));
	}
}
