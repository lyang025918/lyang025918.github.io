...
// Source File Name:   SwedishAnalyzer.java
...
public final class SwedishAnalyzer extends StopwordAnalyzerBase
{
	private static class DefaultSetHolder
	{
		...
		static 
		{
			try
			{
				DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader(org/apache/lucene/analysis/snowball/SnowballFilter, "swedish_stop.txt", IOUtils.CHARSET_UTF_8), Version.LUCENE_CURRENT);
			}
