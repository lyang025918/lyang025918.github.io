...
// Source File Name:   CatalanAnalyzer.java
...
public final class CatalanAnalyzer extends StopwordAnalyzerBase
{
	private static class DefaultSetHolder
	{
		...
		static 
		{
			try
			{
				DEFAULT_STOP_SET = CatalanAnalyzer.loadStopwordSet(false, org/apache/lucene/analysis/ca/CatalanAnalyzer, "stopwords.txt", "#");
			}
