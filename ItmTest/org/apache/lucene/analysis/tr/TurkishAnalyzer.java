...
// Source File Name:   TurkishAnalyzer.java
...
public final class TurkishAnalyzer extends StopwordAnalyzerBase
{
	private static class DefaultSetHolder
	{
		...
		static 
		{
			try
			{
				DEFAULT_STOP_SET = TurkishAnalyzer.loadStopwordSet(false, org/apache/lucene/analysis/tr/TurkishAnalyzer, "stopwords.txt", "#");
			}
