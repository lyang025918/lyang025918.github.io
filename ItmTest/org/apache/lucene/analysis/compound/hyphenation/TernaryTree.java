	...
	implements Cloneable
{
	...
	{
		out.println((new StringBuilder()).append("Number of keys = ").append(Integer.toString(length)).toString());
		out.println((new StringBuilder()).append("Node count = ").append(Integer.toString(freenode)).toString());
		out.println((new StringBuilder()).append("Key Array length = ").append(Integer.toString(kv.length())).toString());
	}
