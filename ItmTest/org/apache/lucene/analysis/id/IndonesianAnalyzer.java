...
// Source File Name:   IndonesianAnalyzer.java
...
public final class IndonesianAnalyzer extends StopwordAnalyzerBase
{
	private static class DefaultSetHolder
	{
		...
		static 
		{
			try
			{
				DEFAULT_STOP_SET = IndonesianAnalyzer.loadStopwordSet(false, org/apache/lucene/analysis/id/IndonesianAnalyzer, "stopwords.txt", "#");
			}
	...
	protected org.apache.lucene.analysis.Analyzer.TokenStreamComponents createComponents(String fieldName, Reader reader)
	{
		...
		return new org.apache.lucene.analysis.Analyzer.TokenStreamComponents(source, new IndonesianStemFilter(result));
	}
