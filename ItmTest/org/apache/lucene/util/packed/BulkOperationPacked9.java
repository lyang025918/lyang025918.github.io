...
// Source File Name:   BulkOperationPacked9.java
...
final class BulkOperationPacked9 extends BulkOperationPacked
{
	...
	static final boolean $assertionsDisabled = !org/apache/lucene/util/packed/BulkOperationPacked9.desiredAssertionStatus();
	...
	public void decode(byte blocks[], int blocksOffset, long values[], int valuesOffset, int iterations)
	{
		for (int i = 0; i < 8 * iterations; i++)
		{
			...
			values[valuesOffset++] = (byte1 & 127L) << 2 | byte2 >>> 6;
			long byte3 = blocks[blocksOffset++] & 0xff;
			values[valuesOffset++] = (byte2 & 63L) << 3 | byte3 >>> 5;
			long byte4 = blocks[blocksOffset++] & 0xff;
			values[valuesOffset++] = (byte3 & 31L) << 4 | byte4 >>> 4;
			long byte5 = blocks[blocksOffset++] & 0xff;
			values[valuesOffset++] = (byte4 & 15L) << 5 | byte5 >>> 3;
