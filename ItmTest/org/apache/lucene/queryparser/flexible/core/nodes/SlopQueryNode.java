...
// Source File Name:   SlopQueryNode.java
...
public class SlopQueryNode extends QueryNodeImpl
	implements FieldableNode
{
	...
	{
		return (new StringBuilder()).append("<slop value='").append(getValueString()).append("'>").append("\n").append(getChild().toString()).append("\n</slop>").toString();
	}
