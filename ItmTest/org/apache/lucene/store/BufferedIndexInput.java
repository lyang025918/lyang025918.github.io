...
//			IndexInput, IndexOutput, IOContext, DataInput
...
public abstract class BufferedIndexInput extends IndexInput
{
	...
	static final boolean $assertionsDisabled = !org/apache/lucene/store/BufferedIndexInput.desiredAssertionStatus();
	...
	public static int bufferSize(IOContext context)
	{
		static class 1
		{
			...
			static final int $SwitchMap$org$apache$lucene$store$IOContext$Context[];

			static 
			{
				$SwitchMap$org$apache$lucene$store$IOContext$Context = new int[IOContext.Context.values().length];
				try
				{
		...
		switch (1..SwitchMap.org.apache.lucene.store.IOContext.Context[context.context.ordinal()])
		{
		case 1: // '\001'
			return 4096;
		}
