...
public abstract class DataOutput
{
	...
	static final boolean $assertionsDisabled = !org/apache/lucene/store/DataOutput.desiredAssertionStatus();
		...
		throws IOException
	{
		...
		} else
		{
			...
			for (Iterator i$ = map.entrySet().iterator(); i$.hasNext(); writeString((String)entry.getValue()))
			{
		...
		throws IOException
	{
		...
		} else
		{
			writeInt(set.size());
			String value;
			for (Iterator i$ = set.iterator(); i$.hasNext(); writeString(value))
				value = (String)i$.next();
