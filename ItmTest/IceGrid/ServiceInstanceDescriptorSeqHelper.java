...
// Source File Name:   ServiceInstanceDescriptorSeqHelper.java
...
public final class ServiceInstanceDescriptorSeqHelper
{
	...
	public static void write(BasicStream __os, List __v)
	{
		...
		} else
		{
			...
			ServiceInstanceDescriptor __elem;
			for (Iterator i$ = __v.iterator(); i$.hasNext(); __elem.__write(__os))
				__elem = (ServiceInstanceDescriptor)i$.next();
	...
	public static List read(BasicStream __is)
	{
		...
		int __len0 = __is.readAndCheckSeqSize(8);
		for (int __i0 = 0; __i0 < __len0; __i0++)
		{
			ServiceInstanceDescriptor __elem = new ServiceInstanceDescriptor();
			__elem.__read(__is);
			__v.add(__elem);
		}
