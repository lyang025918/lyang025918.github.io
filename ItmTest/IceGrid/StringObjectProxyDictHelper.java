...
// Source File Name:   StringObjectProxyDictHelper.java
...
public final class StringObjectProxyDictHelper
{
	...
	public static void write(BasicStream __os, Map __v)
	{
		...
		} else
		{
			...
			for (Iterator i$ = __v.entrySet().iterator(); i$.hasNext(); __os.writeProxy((ObjectPrx)__e.getValue()))
			{
	...
	public static Map read(BasicStream __is)
	{
		...
		for (int __i0 = 0; __i0 < __sz0; __i0++)
		{
			...
			ObjectPrx __value = __is.readProxy();
