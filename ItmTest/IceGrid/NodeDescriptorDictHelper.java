...
// Source File Name:   NodeDescriptorDictHelper.java
...
public final class NodeDescriptorDictHelper
{
	...
	public NodeDescriptorDictHelper()
	{
	}
	...
	public static void write(BasicStream __os, Map __v)
	{
		...
		} else
		{
			...
			for (Iterator i$ = __v.entrySet().iterator(); i$.hasNext(); ((NodeDescriptor)__e.getValue()).__write(__os))
			{
	...
	public static Map read(BasicStream __is)
	{
		...
		for (int __i0 = 0; __i0 < __sz0; __i0++)
		{
			...
			NodeDescriptor __value = new NodeDescriptor();
			__value.__read(__is);
