...
// Source File Name:   AMI_Admin_getNodeLoad.java
...
//			Callback_Admin_getNodeLoad, LoadInfo

public abstract class AMI_Admin_getNodeLoad extends Callback_Admin_getNodeLoad
{

	public AMI_Admin_getNodeLoad()
	{
	}

	public abstract void ice_response(LoadInfo loadinfo);
	...
	public final void response(LoadInfo __ret)
	{
		ice_response(__ret);
	}
