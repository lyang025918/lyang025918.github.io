...
// Source File Name:   TopicDictHelper.java
...
public final class TopicDictHelper
{
	...
	public static void write(BasicStream __os, Map __v)
	{
		...
		} else
		{
			...
			for (Iterator i$ = __v.entrySet().iterator(); i$.hasNext(); TopicPrxHelper.__write(__os, (TopicPrx)__e.getValue()))
			{
	...
	public static Map read(BasicStream __is)
	{
		...
		for (int __i0 = 0; __i0 < __sz0; __i0++)
		{
			...
			TopicPrx __value = TopicPrxHelper.__read(__is);
